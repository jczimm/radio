...
const isAudio = isMobile;
//

const audioPlayer = document.querySelector('#audio-player');
const audio = isAudio ?  audioPlayer.querySelector('audio') : audioPlayer.querySelector('iframe');
...
if (isAudio) {
    ...
    audio.onload = function onLoad(e) {
...
function onWindowResize(e) {
    if (!isAudio) {
        ...
        var withoutIFrame = audioPlayer.clientHeight;
        audio.style = '';
        var withIFrame = audioPlayer.clientHeight;

        audio.style = 'max-height: ' + ((withIFrame > withoutIFrame ? withIFrame : withoutIFrame) - 1.4*16*2) + 'px';
    }
}
